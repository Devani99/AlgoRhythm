# Create Places Service (Google Places API integration)
places_service = """import axios from 'axios';
...
with open("travel-backend/services/placesService.js", "w") as f:
    f.write(places_service)

print("Places Service created successfully!")